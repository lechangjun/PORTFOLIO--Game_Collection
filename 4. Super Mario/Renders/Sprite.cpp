...
float Sprite::Left()
{
	left = position.x - scale.x * textureSize.x * 0.5f;
	return left;
}

float Sprite::Right()
{
	right = position.x + scale.x * textureSize.x * 0.5f;
	return right;
}

float Sprite::Bottom()
{
	bottom = position.y - scale.y * textureSize.y * 0.5f;
	return bottom;
}

float Sprite::Top()
{
	top = position.y + scale.y * textureSize.y * 0.5f;
	return top;
}
//////////////////////////////////
